      ...
      <div className="p-4 pt-2">
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            className="group flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#2081e2] to-[#1868b7] text-white text-sm font-semibold rounded-full hover:from-[#1868b7] hover:to-[#145a9e] transition-all duration-300 shadow-lg shadow-[#2081e2]/20 hover:shadow-[#2081e2]/40"
          >
